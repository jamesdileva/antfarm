...
| 2026-09-11 | S16.4 | Transcript capture on timeout: timeout handler now calls captureAndDispose to read session messages before marking timed_out, preventing loss of agent work that exceeded 600s window; transcripts saved to session_transcripts table for analysis | 116/116 pass - build green - e2e green | |
